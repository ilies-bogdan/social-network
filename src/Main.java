...
public class Main {
    public static void main(String[] args) {
        ...
        networkService.initialize(UserRepositoryFactory.getInstance().createRepository(RepositoryStrategy.database, userFileName, null, null, null),
                new UserValidator(),
                FriendshipRepositoryFactory.getInstance().createRepository(RepositoryStrategy.database, friendshipsFileName, null, null, null));
